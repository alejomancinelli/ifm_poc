...
def build_reference(frames: list[dict]) -> Reference:
    """
    Promedia varios frames de la superficie vacía para usarla como cero.

    Un píxel entra en la referencia solo si fue válido en **todos** los frames:
    uno intermitente en el borde de una caja arruina la resta después.
